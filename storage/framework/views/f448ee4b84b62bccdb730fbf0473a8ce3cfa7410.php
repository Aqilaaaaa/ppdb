...
<html lang="en">
  ...
  <head>
    ...
    <!-- PLUGINS CSS STYLE -->
    <link rel="stylesheet" href="<?php echo e(asset('assets/template/plugins/bootstrap/bootstrap.min.css')); ?> ">
    <link rel="stylesheet" href="<?php echo e(asset('assets/template/plugins/themify-icons/themify-icons.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/template/plugins/slick/slick.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/template/plugins/slick/slick-theme.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/template/plugins/fancybox/jquery.fancybox.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/template/plugins/aos/aos.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/landing-page/css/font-awesome.css')); ?>">

    <!-- CUSTOM CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('assets/template/css/style.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/template/css/preloader.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/template/css/header.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/template/css/superiority.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/template/css/slider-slick.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/template/css/superiority.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/template/css/contact.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/template/css/slider.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/template/css/additional.css')); ?>">
...
<?php /**PATH C:\xampp81\htdocs\PPDB-Wikrama\resources\views/index.blade.php ENDPATH**/ ?>