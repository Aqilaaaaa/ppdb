...
<br>
    ...
    <table width="50%" border="0" style="margin-left:3%;margin-right:2%;float:left">
        ...
        <tr>
            ...
            <td width="3%">:</td>
            <td><?php echo e($student->register_date); ?></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td width="3%">:</td>
            <td><?php echo e($student->school_id); ?></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td width="3%">:</td>
            <td><?php echo e($student->father_phone_no); ?></td>
        </tr>
        <tr>
            <td width="30%" style="font-size: 13px"><b>NO HP Ibu</b></td>
            <td width="3%">:</td>
            <td><?php echo e($student->mother_phone_no); ?></td>
        </tr>
        <tr>
            <td width="30%" style="font-size: 13px"><b>Referensi</b></td>
            <td width="3%">:</td>
            <td><?php echo e($student->reference_type); ?></td>
        </tr>
        <tr>
            <td colspan="3" style="padding: 10px 0;"></td>
        </tr>
        ...
        <tr>
            <td colspan="3">Akses<a style="font: blue; text-decoration: none;" href="/student/login"> student</a>, login gunakan</td>
        </tr>
        <tr>
            <td colspan="3">Username : <?php echo e($student->email); ?></td>
        </tr>
        <tr>
      
            <td colspan="3">Password : <?php echo e($student->nisn); ?></td>
        </tr>
        <tr>
...
</body><?php /**PATH C:\xampp\htdocs\PPDB-Wikrama\resources\views/student/student-print.blade.php ENDPATH**/ ?>