                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card1 mt-3 p-3 g-2">
                            ...
                            <div class="mt-3">
                                <h2 class="text1"><?php echo e($student->full_name); ?></h2>
                            </div>
                                ...
                                <ul class="list-group">
                                    <table cellspacing="0" cellpadding="4">
                                        ...
                                        <tr>
                                            <th width="40%">NISN</th>
                                            <td>:</td>
                                            <td><?php echo e($student->nisn); ?></td>                                        </tr>
                                        <tr>
                                            <th width="40%">Nama</th>
                                            <td>:</td>
                        ...
                        <div class="card card3 mt-3">
                                ...
                                <div class="card-body">
                                    <p style="color: #333; font-size: 0.9rem">
                                        ...
                                        <br>
                                        <a href="#" class="btn mt-3 btn-block btn-primary">Menuju Halaman Pembayaran</a>
                                                                            </p>
                            </div>
                        </div>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\PPDB-Wikrama\resources\views/student/dashboard.blade.php ENDPATH**/ ?>